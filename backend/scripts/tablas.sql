...
nacionalidad INT REFERENCES paises (id_pais),
...
imagen_portada TEXT,
idioma_id INT NOT NULL REFERENCES idiomas (id_idioma)

);

CREATE TABLE biblioteca (
nombre_usuario VARCHAR(32) REFERENCES usuarios(nombre_usuario),
isbn_code int REFERENCES libros(isbn_code),
...
nombre_usuario_seguidor VARCHAR(32) REFERENCES usuarios (nombre_usuario),
nombre_usuario_seguido VARCHAR(32) REFERENCES usuarios (nombre_usuario),
