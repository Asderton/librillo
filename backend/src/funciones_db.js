...
async function Eliminar_libro(isbn_code){
    ...
    const result=await dbclient.query('DELETE FROM libros WHERE isbn_code=$1', [isbn_code]);
...
async function Actualizar_libro(isbn_code) {
    ...
    'UPDATE libros SET  titulo = $2, descripcion = $3, numero_de_paginas = $4, idioma_id = $5  WHERE isbn_libro = $1  RETURNING *',
